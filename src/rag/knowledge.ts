...
export const knowledgeDocuments: Document[] = [
  ...
  new Document({
    ...
    metadata: { id: "memory-saver", title: "MemorySaver" }
  }),
  new Document({
    pageContent:
    ...
    metadata: { id: "checkpointer-restore", title: "Checkpointer restore" }
  })
];
